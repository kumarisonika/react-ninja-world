...
function Nation_Add_button_form() {
...
const [scroll, setScroll] = React.useState<DialogProps['scroll']>('paper');
    const [nanData, setnanData] = useState<INationData>({id:0,nation_name:"",element:"",kage_name:"",description:""})
        ...
        NationAPI.create({nation_name: nationNameData, element: elementData, kage_name: kageNameData, description:nationDescriptionData})
        handleClose()
...
export default Nation_Add_button_form
